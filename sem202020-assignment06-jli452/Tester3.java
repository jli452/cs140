...
public class Tester3 {
	...
	public static void main(String[] args) 
	{
		...
		System.out.println("Expecting: Goat cheese on Mushroom on Small cheese pizza");
		System.out.println("Actual:    " + test.getDescription());
		if(test.getDescription().equals("Goat cheese on Mushroom on Small cheese pizza"))
		...
		System.out.println("Expecting: Pepperoni on Goat cheese on Mushroom on Small cheese pizza");
		System.out.println("Actual:    " + test.getDescription());
		if(test.getDescription().equals("Pepperoni on Goat cheese on Mushroom on Small cheese pizza"))
		...
		System.out.println("Expecting: Mushroom on Pepperoni on Extra cheese on Large sheet pizza");
		System.out.println("Actual:    " + test.getDescription());
		if(test.getDescription().equals("Mushroom on Pepperoni on Extra cheese on Large sheet pizza"))
			System.out.println("Test 1 SUCCEEDED");
		else 
		{
			System.out.println("Test 1 FAILED");
		...
		System.out.println("Expecting: Mushroom on Pepperoni on Extra cheese on Medium cheese pizza");
		System.out.println("Actual:    " + test.getDescription());
		if(test.getDescription().equals("Mushroom on Pepperoni on Extra cheese on Medium cheese pizza"))
			System.out.println("Test 1 SUCCEEDED");
		else 
		{
			System.out.println("Test 1 FAILED");
