...
public class NamesResource {
	...
	public static LocalDate getRandomBirthDate(int maxYear) 
	{
	...
	private static Map<String, String> capitals = Map.ofEntries(
	...
	private static List<String> capitalsList = new ArrayList<String>(capitals.keySet());

	public static void main(String[] args) throws FileNotFoundException 
	{
		try (PrintStream ps = new PrintStream("students.txt")) 
		{
			int numStudents = 50;
			ps.println(numStudents + " THE NUMBER OF ENTRIES THAT FOLLOW");
			for(int i = 0; i < numStudents; i++)
			{
				LocalDate d = getRandomBirthDate(2017);
				int k = ranGen.nextInt(binghamtonMajors.length);
				double x = 260 + 140*Math.random();
				x = Math.round(x)/100.0;
				ps.println(getRandomLastName() + ", " + getRandomFirstName() + ", " + 
						d.getYear() + ", " + d.getMonthValue() + ", " + d.getDayOfMonth()
						+ ", " + binghamtonMajors[k]  + ", " + x);
			}
		}
	}
}
